          ...
          <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            <div className="md:w-[316px]">
              ...
              <h1 className="text-white text-lg font-extrabold">
                <span className="text-red-600 text-lg">100</span>acres
              </h1>
              <p />
              <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">
                100acres is only an intermediary offering its platform to advertise properties of Seller for a
                Customer/Buyer/User coming on its Website and is not and cannot
                be a party to or privy to or control in any manner any
                transactions between the Seller and the Customer/Buyer/User. All
                the offers and discounts on this Website have been extended by
                various Builder(s)/Developer(s) who have advertised their
                products. 100acres is only communicating the offers and not
                selling or rendering any of those products or services. It
                neither warrants nor is it making any representations with
                respect to offer(s) made on the site.
              </p>
            ...
            <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
              ...
              <div className="mt-6 flex flex-col gap-4 sm:mt-0">
                ...
                <div className="flex gap-4 sm:flex-col">
                  <span className="text-red-600">To be Available Soon</span>
